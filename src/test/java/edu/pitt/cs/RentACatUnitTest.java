...
public class RentACatUnitTest {
	...
	public void testGetCatNumCats3() throws Exception {
		...
		Cat newCat = (Cat) gc.invoke(r, 2);

		assertNotNull(newCat);
		assertEquals(2, newCat.getId());
	}
	...
	public void testListCatsNumCats0() throws Exception {
		...
		Method gc = r.getClass().getDeclaredMethod("listCats");
		gc.setAccessible(true);
		assertEquals("", gc.invoke(r));
	}
